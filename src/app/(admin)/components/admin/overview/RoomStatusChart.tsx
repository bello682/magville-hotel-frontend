...
export default function RoomStatusChart({ roomStatus }: RoomStatusChartProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm transition-colors overflow-hidden">
      <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-6">
        Room Status Breakdown
      </h3>
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
        <div className="relative w-32 h-32 md:w-40 md:h-40 shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-[9px] md:text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400">
              Total Rooms
            </span>
          </div>
        </div>
