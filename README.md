...
- Cards / Panels / Nav: bg-white dark:bg-slate-900
- Secondary / Badges:  bg-slate-100 dark:bg-slate-800
- Borders:              border-slate-200 dark:border-slate-800
- Primary Text:         text-slate-900 dark:text-slate-100
- Muted Text / Labels:  text-slate-500 dark:text-slate-400
- Accent Color:         amber-500 (text-amber-500, bg-amber-500)
